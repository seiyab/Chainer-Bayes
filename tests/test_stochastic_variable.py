...
class TestStochasticVariable(unittest.TestCase):
    ...
    def test_sample(self):
        ...
        self.assertFalse(x.is_determined)

        sample = x.sample()

        self.assertTrue(x.is_sampled)
        self.assertTrue(x.is_determined)
    ...
    def test_sample_bernoulli(self):
        ...
        self.assertFalse(p.is_determined)

        sample = p.sample()

        self.assertTrue(p.is_determined)
        self.assertIsInstance(sample, ch.Variable)
    ...
    def test_dependency(self):
        ...
        self.assertIn(x, y.dependencies)
